  ...
  return <>
    ...
    <main id="top">
      ...
      <section id="iletisim" className="section contact">
        <div className="container contactGrid"><div><div className="eyebrow">İletişim</div><h2>Projeniz için doğru çözümü birlikte planlayalım.</h2><p>Yangın güvenliği, ürün tedariği, acil tahliye planı veya karbon yönetimi için bize ulaşın.</p><div className="actions"><a className="btn primary" href="mailto:info@orvyn.com.tr">E-posta Gönder</a><a className="btn secondary" href="tel:+905078959294">Hemen Ara</a></div></div><div className="contactCards"><div><Phone/><b>Telefon</b><p>0507 895 92 94<br/>0541 783 77 18</p></div><div><Mail/><b>E-posta</b><p>info@orvyn.com.tr</p></div><div><MapPin/><b>İstanbul Şube</b><p>Dudullu OSB, 6. Cd. No:35, 34776 Ümraniye / İstanbul</p></div><div><MapPin/><b>Çankırı Merkez Ofis</b><p>ÇANKIRI YAKINKENT OSB, 2. Cadde No:4, 18702 Çankırı</p></div></div></div>
      </section>
    </main>

    <div className="float"><a href="https://wa.me/905078959294" target="_blank">WhatsApp</a><a href="tel:+905417837718">Hemen Ara</a><a href="mailto:info@orvyn.com.tr">E-Posta</a></div>
    <footer><div className="container footerGrid"><div><Image src="/images/orvyn-logo.png" alt="ORVYN" width={220} height={75}/><p>Mühendislik. Teknoloji. Güvenlik.</p></div><div><b>Hizmetler</b><a href="#hizmetler">Yangın risk analizi</a><a href="#hizmetler">Acil tahliye planı</a><a href="#hizmetler">Yangından korunma ekipmanları</a><a href="#karbon">Karbon yönetimi</a></div><div><b>Standartlar</b><a href="#standartlar">TS EN</a><a href="#standartlar">NFPA</a><a href="#standartlar">FM Global</a><a href="#standartlar">Yangın Yönetmeliği</a></div><div><b>Ürünler</b><a href="#urunler">Yangın tüpleri</a><a href="#urunler">Yangın dolapları</a><a href="#urunler">Sprinkler</a></div><div><b>İletişim</b><p>0507 895 92 94<br/>0541 783 77 18<br/>info@orvyn.com.tr</p></div></div></footer>
  </>;
}
